...
angularApp.controller("HomeController",function($resource){
  ...
  vm.getCityTemperature = function(){
   ...
   vm.getCityForecast = function(){
    console.log(vm.cityName);
    var weatherForecast = $resource('http://api.openweathermap.org/data/2.5/forecast',
     {q:vm.cityName,appid:'27d43832d2a4adcb97fcbfa23db130aa',cnt:5});
    vm.weatherForecastResponse = weatherForecast.get();
   }
});
